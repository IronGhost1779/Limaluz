...
@TeleOp(name = "Motor Directions 2", group = "Teleop Test")
public class MotorDirections extends OpMode {
    ...
    public void loop() {
        ...
        telemetryA.addData("Left Front Motor Direction: ", leftFront.getCurrentPosition());
        telemetryA.addData("Left Rear Motor Direction: ", leftRear.getCurrentPosition());
        telemetryA.addData("Right Front Motor Direction: ", rightFront.getCurrentPosition());
        telemetryA.addData("Right Rear Motor Direction: ", rightRear.getCurrentPosition());
        telemetryA.update();
    }
}